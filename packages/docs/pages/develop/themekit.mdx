...
<Tabs.Tab>```bash pnpm add @reblog/themekit ```</Tabs.Tab>

<Tabs.Tab>```bash yarn add @reblog/themekit ```</Tabs.Tab>

<Tabs.Tab>```bash npm install @reblog/themekit ```</Tabs.Tab>

<Tabs.Tab>```bash bun add @reblog/themekit ```</Tabs.Tab>
